...
public class QOrderInfo extends EntityPathBase<OrderInfo> {
    ...
    private static final long serialVersionUID = 1307447276L;
    ...
    public final EnumPath<org.hidog.payment.constants.PayMethod> payMethod = createEnum("payMethod", org.hidog.payment.constants.PayMethod.class);
    ...
    public final EnumPath<org.hidog.order.constants.OrderStatus> status = createEnum("status", org.hidog.order.constants.OrderStatus.class);
